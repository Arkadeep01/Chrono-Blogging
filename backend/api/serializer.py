...
'''
    ...
    2. User registration
    3. Converting database objects → JSON (API response)
    4. Validating incoming data (API request)
    5. Handling related/nested data (posts, comments, profiles, etc.)
'''
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = api_models.User                                                 # Specify the model that this serializer is associated with
...
# --------------------------------
# Password Reset serializer for user registration
# --------------------------------
...
# --------------------------------
# Category serializer for user registration
# --------------------------------
...
# --------------------------------
# BookMark serializer for user registration
# --------------------------------
...
# --------------------------------
# Notification serializer from user 
# --------------------------------  
